App.controller('home', function(page) {
       ...
       App.controller('sendemail', function(page) { 
              ...
              $(page).find('#send-button')
                      ...
                      //pphp email send check
                     $.ajax({
                      type: 'GET',
                      url: 'exampleurl@.como/sendemail.php?callback=response',
                    ...
                    if (typeof localStorage !== 'undefined'){
                        ...
                        if(localStorage.getItem("recipient-list") != null){
                           ...
                           recipientList = JSON.parse(localStorage.getItem("recipient-list")); //recipient display in the input 
                        }
